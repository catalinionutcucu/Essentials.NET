...
{
    /// <summary>
    /// Maps a <see cref = "Result{TResult,TError}" /> instance to a value of type <typeparamref name = "TMap" /> on the result state.
    /// </summary>
    ...
    /// <summary>
    /// Maps asynchronously a <see cref = "Result{TResult,TError}" /> instance to a value of type <typeparamref name = "TMap" /> on the result state.
    /// </summary>
    /// <returns>A value of type <typeparamref name = "TMap" />.</returns>
    ...
    /// <summary>
    /// Converts the request result to an HTTP response of type <see cref = "IResult" /> based on the result state of a <see cref = "Result{Error}" /> instance.
    /// </summary>
...
{
    /// <summary>
    /// Maps a <see cref = "Result{TError}" /> instance to a value of type <typeparamref name = "TMap" /> on the result state.
    /// </summary>
    /// <returns>A value of type <typeparamref name = "TMap" />.</returns>
    ...
    /// <summary>
    /// Maps asynchronously a <see cref = "Result{TError}" /> instance to a value of type <typeparamref name = "TMap" /> on the result state.
    /// </summary>
    /// <returns>A value of type <typeparamref name = "TMap" />.</returns>
    ...
    /// <summary>
    /// Converts the request result to an HTTP response of type <see cref = "IResult" /> based on the result state of a <see cref = "Result{TResult,Error}" /> instance.
    /// </summary>
    /// <returns>An HTTP response of type <see cref = "IResult" />.</returns>
